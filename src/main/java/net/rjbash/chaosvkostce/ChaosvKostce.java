...
public class ChaosvKostce
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "chaosincube";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if(event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.accept(ModBlocks.ABSOLUTE_ALEXANDRITE_BLOCK);
            event.accept(ModBlocks.ALEXANDRITE_ORE_BLOCK);
            event.accept(ModBlocks.RAW_ALEXANDRITE_ORE_BLOCK.get());
        }
